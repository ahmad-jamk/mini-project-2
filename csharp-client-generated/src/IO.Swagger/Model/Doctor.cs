...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Doctor :  IEquatable<Doctor>, IValidatableObject
    {
        /// <summary>
        ...
        public Doctor(long? id = default(long?), string name = default(string), string specialty = default(string))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as Doctor);
        }

        /// <summary>
        /// Returns true if Doctor instances are equal
        /// </summary>
        /// <param name="input">Instance of Doctor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Doctor input)
        {
            if (input == null)
                return false;
